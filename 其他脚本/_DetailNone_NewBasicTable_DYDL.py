...
def CutData_insert():
    ...
    try:
        ...
        # 33223 ，蚂蚁搬家 分批次处理！
        # 2000 条  大致跑一个小时
        for page1 in range(30001,33224):
            SQL_search1 = 'select shebei_id,shebei_name,SBBM_ID,line_id,XBGXT_line_name,TG_ID,city_Name,Country_Name,Yunwei_name,BdZ_name,Sale_line_id,LineEStop_line_name,E_StopTime,E_ResumeTime,StopTime_Long,StopTime_Date,StopTime_15dot from StopT15_NewBasci_Table  where id = %s  '%  page1
            ...
            q2_StopTime_15dot = data1["StopTime_15dot"]



            q1_list.append((q1_shebei_id,q1_shebei_name,q1_SBBM_ID,q1_line_id,q1_XBGXT_line_name,q2_LineEStop_line_name,q1_TG_ID,q2_city_Name,q2_Country_Name,q2_Yunwei_name,q2_BdZ_name,q2_Sale_line_id,q2_E_StopTime,q2_E_ResumeTime,q2_StopTime_Long,q2_StopTime_Date,q2_StopTime_15dot))
    except:
        pass
...
def insertDB(content):
    ...
    cursor = connection.cursor()
    try:
        cursor.executemany("insert into dot15_f_NBBT_DYDL_t (shebei_id,shebei_name,SBBM_ID,line_id,XBGXT_line_name,LineEStop_line_name,xbgxt_TG_ID,city_Name,Country_Name,Yunwei_name,BdZ_name,Sale_line_id,E_StopTime,E_ResumeTime,StopTime_Long,StopTime_Date,BbasicT_StopTime_15dot,DYDL_StopTime_15dot,DYDL_TG_ID,ID_i,DATA_DATE,PHASE_FLAG,U1,U2,U3,U4,U5,U6,U7,U8,U9,U10,U11,U12,U13,U14,U15,U16,U17,U18,U19,U20,U21,U22,U23,U24,U25,U26,U27,U28,U29,U30,U31,U32,U33,U34,U35,U36,U37,U38,U39,U40,U41,U42,U43,U44,U45,U46,U47,U48,U49,U50,U51,U52,U53,U54,U55,U56,U57,U58,U59,U60,U61,U62,U63,U64,U65,U66,U67,U68,U69,U70,U71,U72,U73,U74,U75,U76,U77,U78,U79,U80,U81,U82,U83,U84,U85,U86,U87,U88,U89,U90,U91,U92,U93,U94,U95,U96) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == "__main__":
    ...
    for q1_item in q1_list:
        # print("TG_ID索引:",q1_item[6],type(q1_item[6]),"停电日期：",q1_item[15],type(q1_item[15]))
        # time.sleep(9)
        dot_15 = q1_item[16]
        ...
        if len_row != 0: # 第一个判断，必须要查询到内容
            for item in row: #第2个判断，在确实有返回值时，必须满足U1-U94都是内容的（也就是没有停电）
                U1_96 = item[4:]
                L_None = count_None(U1_96) #计None的个数
                if int(L_None) !=0 and (float(dot_15)/int(L_None))>=1.2 and 0 not in U1_96:  # 1.剔除没有None 2. 大基准的停电时间点数除以电压电流表的点数大于2  3. 剔除全部为0的情况

                    l1_tu = q1_item #一共17个字段，最后一个是大基准的停电时间的点数计算
                    l_mid = str(L_None) # 电压电流表，计算停电点数
                    l2_tu = item
                    f_tu = l1_tu +(l_mid,)+ l2_tu  #一共118个字段，
                    f_b_list.append(f_tu)
                    print(dot_15,L_None,f_tu)
...
# drop table dot15_f_NBBT_DYDL_t;





# create table dot15_f_NBBT_DYDL_t(
...
# StopTime_Long text,
# StopTime_Date text,
# BbasicT_StopTime_15dot text,
# DYDL_StopTime_15dot text,
# DYDL_TG_ID text,
# ID_i text,
# DATA_DATE text,
# PHASE_FLAG text,
