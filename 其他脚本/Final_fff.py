...
def insertDB(content):
    ...
    cursor = connection.cursor()
    try:
        cursor.executemany("insert into Final_fff (DT,q1_line_id,NB_LINE_NAME,q1_stopC_time,NB_line_stopTime,NB_line_stopTime_Plus5,twoTime_cut) values (%s,%s,%s,%s,%s,%s,%s)", content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
    ...
    for q1_item in iter(q1_list_Dcopy):
        ...
        for q2_item in iter(q2_list_Dcopy):
            ...
            if  line_3_long ==3:
                ...
                if q1_line_id == q2_line_id and int_comp in (0,300):
                    # print((q1_table_id,q1_line_id,q2_line_name,str_q1_time,str_q2_stopTime,str_q2_stopTimePlus5,int_comp))
                    # time.sleep(9)
                    l3.append((q1_table_id,q1_line_id,q2_line_name,str_q1_time,str_q2_stopTime,str_q2_stopTimePlus5,int_comp))
...
# DT,q1_line_id,NB_LINE_NAME,q1_stopC_time,NB_line_stopTime,NB_line_stopTime_Plus5,twoTime_cut
# create table Final_fff(
...
# 2019-11-13 14:09:30.664386
# 向MySQL中添加数据成功！
# 筛选出异常数据，并插入新创建的异常数据汇总表～～
# 2019-11-14 02:14:03.879544