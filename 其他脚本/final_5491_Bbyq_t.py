...
# 转变思路：1.现将匹配的大变压器标的数据导出成果文件，final_5491_From_Bbyq.csv
#2. 然后再将这5千多条导入数据库一边后续再深入研究
# 3.最开始要把得出的5000多条筛选数据导出 (完成)
# 线路相同，时间相同，比较变压器的的数据。先做计数运算，再比较基准表与输出的数据表的差异！
...
if __name__ =='__main__':
    ...
    db_table = readcsv(r"E:\\final_5191_.csv")
    big_list = []
    try:
        ...
        csv_dict_write('E:\\final_5491_From_Bbyq.csv',head,big_list)
        print("数据导出完成～")
        print(datetime.datetime.now())
    except:
        pass
